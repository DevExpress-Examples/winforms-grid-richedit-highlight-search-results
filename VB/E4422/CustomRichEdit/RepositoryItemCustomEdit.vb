...
Namespace CustomEditor
    ...
    Public Class RepositoryItemCustomEdit
        ...
        Public Shared Sub RegisterCustomEdit()
            ...
            Call EditorRegistrationInfo.Default.Editors.Add(New EditorClassInfo(CustomEditName, GetType(CustomEdit), GetType(RepositoryItemCustomEdit), GetType(CustomEditViewInfo), New RichTextEditPainter(), True, img))
        End Sub
